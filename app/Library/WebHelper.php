...
class WebHelper {
	...
	public static function get_emr_design_file_location_guest($design_category = '', $design_type = '', $design_code = '', $image_type = '', $company_code = "")
	{
		$file_url = "";
		$folder = "mahapura";
		$file_ext = [".jpg", ".jpeg", ".png", ".JPG", ".JPEG", ".PNG"];

		if($company_code == 'PJ' ||$company_code == 'PJ2' ) { $folder = "sitapura"; }
