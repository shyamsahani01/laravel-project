...
class AttendncesMissingINExport implements FromView
{
    protected $request;
    ...
    public function view(): View
    {
        ...
        return view('exports.missing-in-attendnce', ['attendncedata' => $data,'startdate'=>date('Y-m-d',(strtotime($this->request->start_date))),'enddate'=>date('Y-m-d',(strtotime($this->request->end_date)))]);
    }
}