...
class AttendncesMissingExport implements FromView
{
    protected $request;
    ...
    public function view(): View
    {
        ...
        $data = $query->get();
       // dd($attendnces);
        return view('exports.missing-attendnce', ['attendncedata' => $data,'startdate'=>date('Y-m-d',(strtotime($this->request->start_date))),'enddate'=>date('Y-m-d',(strtotime($this->request->end_date)))]);
    }
}