...
<div style="text-align: center;max-width: min-content;">
...
<table width="720px"  cellpadding="4" cellspacing="0">

  <tr valign="top" style="text-align: left;">
    <td width="100" style="font-weight: bold; color: black; height: max-content; padding-top: 0in; padding-bottom: 0.03in; padding-left: 0.08in; padding-right: 0.08in">
      <p class="western" style="margin-bottom: 0in">Start Date:</p>
    </td>
    <td width="100" style="color: black; height: max-content; padding-top: 0in; padding-bottom: 0.08in; padding-left: 0.03in; padding-right: 0.08in">
    ...
    <td width="100" style=" height: max-content; padding-top: 0in; padding-bottom: 0.08in; padding-left: 0.03in; padding-right: 0.08in">
  ...
  <tr valign="top" style="text-align: left;">
    ...
    <td width="100" style="height: max-content; padding-top: 0in; padding-bottom: 0.03in; padding-left: 0.08in; padding-right: 0.08in">
      <p class="western" style="margin-bottom: 0in">{{ $salary_slip->employee }}</p>
    </td>

    <td width="100" style="font-weight: bold; color: black; height: max-content; padding-top: 0in; padding-bottom: 0.08in; padding-left: 0.08in; padding-right: 0.08in">
      <p class="western" style="margin-bottom: 0in">Company:</p>
    </td>
    <td width="100" style=" height: max-content; padding-top: 0in; padding-bottom: 0.08in; padding-left: 0.08in; padding-right: 0.08in">
...
<table width="720px" cellpadding="7" cellspacing="0">
    <td width="100" style="text-align: center; border-top: 1px solid #000001; border-bottom: 1px solid #000001; border-left: 1px solid #000001; border-right: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in">
      <p class="western">
        <font color="black">
          <font color="black">
            <b>Earnings</b>
    ...
    <td width="100" style="text-align: center; border-top: 1px solid #000001; border-bottom: 1px solid #000001; border-left: 1px solid #00000a; border-right: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in">
      <p class="western">
        <font color="black">
          <b>Amount</b>
        </font>
    ...
    <td width="100" style="text-align: center; border-top: 1px solid #000001; border-bottom: 1px solid #000001; border-left: 1px solid #00000a; border-right: 1px solid #000001; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in">
      <p class="western">
        <font color="black">
          <b>Amount</b>
        </font>
  ...
  <tr valign="top">
    <td width="100" height="169" style="text-align: left; border-top: 1px solid #000001; border-bottom: 1px solid #000001; border-left: 1px solid #000001; border-right: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in">
    ...
    <td width="100" style="border-top: 1px solid #000001; border-bottom: 1px solid #000001; border-left: 1px solid #00000a; border-right: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in">
      @foreach ($salary_slip_data as $key => $value)
        @if($value->parentfield == 'earnings')
    ...
    <td width="100" style="text-align: left; border-top: 1px solid #000001; border-bottom: 1px solid #000001; border-left: 1px solid #00000a; border-right: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in">
      @foreach ($salary_slip_data as $key => $value)
    ...
    <td width="100" style="border-top: 1px solid #000001; border-bottom: 1px solid #000001; border-left: 1px solid #00000a; border-right: 1px solid #000001; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in">
      @foreach ($salary_slip_data as $key => $value)
        @if($value->parentfield == 'deductions')
        <p class="western" style="margin-bottom: 0in; color: black;">{{ round($value->amount) }}</p>
        @endif
  ...
  <tr>
    <td colspan="4" width="632" height="20" style=" text-align: left; border: 1px solid #000001; padding-top: 0.03in; padding-bottom: 0.08in; padding-left: 0.08in; padding-right: 0.08in">
      <p class="western">
  ...
  <tr>
    <td colspan="4" width="632" height="19" style="text-align: left; border: 1px solid #000001; padding-top: 0.03in; padding-bottom: 0.08in; padding-left: 0.08in; padding-right: 0.08in">
      <p class="western">
