...
<table id="designtable" class="table table-bordered design1-form1-table" style="width:100%;">
    ...
    <tbody>
      ...
      <?php
        ...
        @php
        $count = 1;
        $total_yearly_data = count($yearly_data);
        @endphp
        @foreach($yearly_data as $key => $data)
        @php
        $count++;
        @endphp

        <!-- printf($total_yearly_data);
        die; -->
        ...
        <?php
              $temp_data = [];
               ...
               $temp_data = [
                 "year" => $current_finesiacl_year,
                 "yearly_payment_days" => $yearly_payment_days,
                 "yearly_total_present" => $yearly_total_present,
                 "yearly_gross_pay" => $yearly_gross_pay,
                 "yearly_hra_amount" => $yearly_hra_amount,
                 "yearly_b_amount" => $yearly_b_amount,
                 "yearly_cca_amount" => $yearly_cca_amount,
                 "yearly_ta_amount" => $yearly_ta_amount,
                 "yearly_wa_amount" => $yearly_wa_amount,
                 "yearly_esi_amount" => $yearly_esi_amount,
                 "yearly_pf_amount" => $yearly_pf_amount,
                 "yearly_abry_amount" => $yearly_abry_amount,
                 "yearly_ip_amount" => $yearly_ip_amount,
                 "yearly_ot_amount" => $yearly_ot_amount,
                 "yearly_ad_amount" => $yearly_ad_amount,
                 "yearly_lhd_amount" => $yearly_lhd_amount,
                 "yearly_gmi_amount" => $yearly_gmi_amount,
                 "yearly_it_amount" => $yearly_it_amount,
                 "yearly_a_amount" => $yearly_a_amount,
                 "yearly_net_pay" => $yearly_net_pay,
               ];
