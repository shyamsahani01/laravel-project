...
@foreach($salary_sheet_data['direct'] as $key => $data)
...
@foreach($salary_sheet_data['indirect'] as $key => $data)
...
@foreach($salary_sheet_data['gross_data'] as $key => $data)
   @if ($data->occupation_accounts == 'Direct') @php $gross_1 = $data->gross_monthly_salary; $direct_1 = $data->employee_count; @endphp @endif
   @if ($data->occupation_accounts == 'Indirect') @php $gross_2 = $data->gross_monthly_salary; $indirect_1 = $data->employee_count; @endphp @endif
@endforeach
...
@php
    ...
    $employee_total = $direct_1 + $indirect_1;
 ...
 <table id="datatable" class="table table-striped table-bordered" style="width:100%">
    <thead>
       ...
       <tr style="text-align: justify;">
         ...
         <th style="text-align: center;  width: 15%; border: 1px solid black; font-weight: bold;">Occupation - Accounts</th>
    ...
    <tbody>
      <tr  style="text-align: center;">
        ...
        <td style="text-align: center; border: 1px solid black;">Direct</td>
        <td style="text-align: center; border: 1px solid black;">{{ number_format($gross_1) }}</td>

        <td style="text-align: center; border: 1px solid black;">{{ number_format($direct_1) }}</td>
      ...
      <tr  style="text-align: center;">
        ...
        <td style="text-align: center; border: 1px solid black;">Indirect</td>
        <td style="text-align: center; border: 1px solid black;">{{ number_format($gross_2) }}</td>

        <td style="text-align: center; border: 1px solid black;">{{ number_format($indirect_1) }}</td>
