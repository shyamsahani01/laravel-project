...
<table id="datatable" class="table table-bordered" style="width:100%">
   <thead>
      <tr  >
        <th></th>
        <th style="text-align: center; width: 10%;border: 1px solid black; font-weight: bold;" colspan="4" >{{ $company }}</th>
      </tr >
      <tr >
        <th></th>
        <th style="text-align: center; width: 10%;border: 1px solid black; font-weight: bold;" colspan="4" >{{  "Monthly Attendance Sheet of  " .  $month_name . "-" . $year }}</th>
      </tr >
      <tr >
        <th style="text-align: center; width: 10%;border: 1px solid black; font-weight: bold;">S.No.</th>
        <th style="text-align: center; width: 20%;border: 1px solid black; font-weight: bold;">ERP Code</th>
        ...
        <th style="text-align: center; width: 15%;border: 1px solid black; font-weight: bold;">ESSL Code</th>
        <th style="text-align: center; width: 20%;border: 1px solid black; font-weight: bold;">Particular</th>
        @for($i=1; $i<=$total_date; $i++)
          <th style="text-align: center; width: 15%;border: 1px solid black; font-weight: bold;">{{ $i . " " . date("D", strtotime( $year ."-" . $month . "-" . ( ($i<=9) ? "0".$i : $i ) ) ) }}</th>
        @endfor
        <!-- <th style="text-align: center; width: 25%;border: 1px solid black; font-weight: bold;">Days</th> -->
        <th style="text-align: center; width: 25%;border: 1px solid black; font-weight: bold;">Total Pay Days</th>
        <th style="text-align: center; width: 25%;border: 1px solid black; font-weight: bold;">Total  OT</th>
        <!-- <th style="text-align: center; width: 25%;border: 1px solid black; font-weight: bold;">Total  Actual  OT</th> -->
        <th style="text-align: center; width: 25%;border: 1px solid black; font-weight: bold;">Total Paid OT</th>
      </tr>
   </thead>
   <tbody>
 @if (count($compliance_data) > 0)
   ...
   ?>
      ...
      @for($i= 0; $i<4; $i++)
          @if($i==0)
          <tr>
            <td rowspan="4" style="text-align: center;border: 1px solid black;">{{ $count++ }}</td>
            <td rowspan="4" style="text-align: center;border: 1px solid black;">{{ $data->employee  }}</td>
            <td rowspan="4" style="text-align: center;border: 1px solid black;">{{ $data->employee_name }}</td>
            <td rowspan="4" style="text-align: center;border: 1px solid black;">{{ $data->parent_department }}</td>
            <td rowspan="4"  style="text-align: center;border: 1px solid black;">{{ $data->employee_number_new }}</td>
            <td  style="text-align: center;border: 1px solid black;  font-weight: bold;">Status</td>
            @for($j=1; $j<=$total_date; $j++)
              @if(isset($date_data[$j]['status'])) <td style="text-align: center;border: 1px solid black;  font-weight: bold; background: @if(isset($date_data[$j]['background'])){{ $date_data[$j]['background'] }}@endif">  {{ $date_data[$j]['status'] }} </td>
              @else <td style="text-align: center;border: 1px solid black;"></td>
              @endif
            @endfor
            ...
            <td rowspan="4" style="text-align: center;border: 1px solid black;">{{ $total_pay_days }}</td>
            <td rowspan="4" style="text-align: center;border: 1px solid black;">{{ $monthly_ot }}</td>
            <!-- <td rowspan="4" style="text-align: center;border: 1px solid black;">{{ $act_monthly_ot }}  </td> -->
            <td rowspan="4" style="text-align: center;border: 1px solid black; background: @if($monthly_ot != $data->ot_hour ){{ '#77e9c3' }}@endif">{{ $data->ot_hour }}  </td>
          </tr  >

          @elseif($i==1)
          <tr>
            <td style="text-align: center;border: 1px solid black;">In Time</td>
            @for($j=1; $j<=$total_date; $j++)
              @if(isset($date_data[$j]['in_time']))  <td style="text-align: center;border: 1px solid black;"> {{ $date_data[$j]['in_time'] }}  </td>
              @else <td style="text-align: center;border: 1px solid black;"></td>
              @endif
            @endfor
          </tr>
          @elseif($i==2)
          <tr>
            <td style="text-align: center;border: 1px solid black;">Out Time</td>
            @for($j=1; $j<=$total_date; $j++)
              @if(isset($date_data[$j]['out_time']))  <td style="text-align: center;border: 1px solid black;"> {{ $date_data[$j]['out_time'] }} </td>
              @else <td style="text-align: center;border: 1px solid black;"></td>
              @endif
            @endfor
          </tr>
          @else
          <tr>
            <td style="text-align: center;border: 1px solid black;">Duration</td>
            @for($j=1; $j<=$total_date; $j++)
              @if(isset($date_data[$j]['duration']))  <td style="text-align: center;border: 1px solid black;"> {{ $date_data[$j]['duration'] }} </td>
              @else <td style="text-align: center;border: 1px solid black;"></td>
              @endif
            @endfor
          </tr  >
