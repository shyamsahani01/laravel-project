...
<tr>
    <td style="text-align:left; padding:10px 0px 20px 20px; border-bottom:1px solid #e1e1e1;" bgcolor="#f9f9f9">
        ...
        <div style="margin:20px auto 10px; font-size:16px;">You Have New Message For PinkCity Jweelers<span style="color : #043278;">{{env('APP_NAME')}} </div>
        ...
        <p style="margin:10px auto 10px;">Open Link <a href="{{url('message/chat/'.$messagedata->id)}}">Click Here</a></p>
        </div>
