                   ...
                   <div class="shadow-lg p-3 mb-5 bg-white rounded">
                     <div class="x_title">
                       ...
                       <div class="form-group row order-form ">
                         ...
                         <div class="form-group row order-form col-md-4">
                           <div class="col-md-12 form-group order-form">
                             @if (WebHelper::get_emr_design_file_location($design_details->DmCtg, $design_details->DmTcTyp, $design_details->DmCd) != "")
                             <div class="col-sm-9">
                               <img id='design-{{ $design_details->DmCd  }}' style = "max-height: 200px;" class="col-sm-10" onclick=displayImage('{{ $design_details->DmCd  }}') src='{{ WebHelper::get_emr_design_file_location($design_details->DmCtg, $design_details->DmTcTyp, $design_details->DmCd)  }}' >
                               <!-- <button type='button' class='btn btn-primary btn_size_1' onclick=displayImage('{{ $design_details->DmCd  }}') >
