                      ...
                      <div class="form-group row order-form ">
                       <div class="col-md-12">
                         ...
                         <div class="form-group row order-form col-md-12">
                           ...
                           <div class="col-md-4 form-group order-form">
                             <label for="" class="col-sm-6 col-form-label bold-label">Transfer Quantity</label>
                             <div class="col-sm-6">
                               <input type="text" readonly class="form-control from-custom-style"  value="@if(isset($bag_transaction_details->TTrfQty)){{ $bag_transaction_details->TTrfQty }}@endif"  >
                             </div>
                           </div>
                         </div>
                         ...
                         <div class="form-group row order-form col-md-12">
                           ...
                           <div class="col-md-4 form-group order-form">
                             <label for="" class="col-sm-3 col-form-label bold-label">Multiple Issue / Receive</label>
                               <div class="col-sm-9">
                                 <input type="text" readonly class="form-control from-custom-style"  value="@if(isset($bag_transaction_details->TMultiIr)){{ $bag_transaction_details->TMultiIr  }}@endif">
                               </div>
                           </div>
