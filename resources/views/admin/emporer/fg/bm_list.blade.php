...
$showurl = url("/emporer/finish_good_bm/list?$str");
@endphp
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="shadow-lg p-3 mb-5 bg-white rounded" style="margin-bottom: 20px !important;">
                        <form method="GET" id="filter_form" action="{{ url('/emporer/finish_good_bm/list') }}">
                            <div class="x_title">
                                ...
                                <a href="{{ url('/emporer/finish_good_fm/list') }}" style="color: white;" class="btn btn-danger design1-form1-btn">Refresh</a>
                    ...
                    <div class="shadow-lg p-3 mb-5 bg-white rounded" style="margin-bottom: 20px !important;">
                      <div class="card-body">
                        ...
                        <div class="btn-group">
                         ...
                         {{ $finish_good_data->links('vendor.pagination.bootstrap-4') }}
                         </div>
                       </div>
                    </div>
                </div>
