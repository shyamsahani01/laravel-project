...
$showurl = url("/emporer/finish_good/list?$str");
@endphp
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="shadow-lg p-3 mb-5 bg-white rounded" style="margin-bottom: 20px !important;">
                        <form method="GET" id="filter_form" action="{{ url('/emporer/finish_good/list') }}">
                            <div class="x_title">
                                ...
                                <a href="{{ url('/emporer/finish_good/list') }}" style="color: white;" class="btn btn-danger design1-form1-btn">Refresh</a>
