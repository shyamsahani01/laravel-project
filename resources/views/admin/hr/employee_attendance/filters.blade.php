<div class="container-fluid card">
   ...
   @if(request()->segment(3) == 'emp_attendance_report')
   <div class="x_title">
      <h2>{{ $title }}</h2>
         ...
         <div class="row">
            ...
            <div class="col-md-2 col-sm-12  form-group">
               <select  name="year" class="form-control">
                  ...
                  <option value="{{ $i }}" @if(request()->year == $i || $year == $i ) Selected @endif>{{ $i }}</option>
                  @endfor
               </select>
            </div>
            ...
            <div class="col-md-2 col-sm-6">
               ...
               <a href="{{ url('/hr/employee_attendance/emp_attendance_report') }}" style="color: white;" ><button type="button" title="Refresh" class="btn btn-danger"><i class="fa fa-refresh"></i></button></a>
