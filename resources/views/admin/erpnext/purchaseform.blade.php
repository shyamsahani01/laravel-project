...
<style type="text/css">
    @font-face
    {
        ...
        /* Font path*/
        src: url('http://127.0.0.1:8000/css/Kruti_Dev_090_Wide.ttf');
    }
    body
    {
        font-size: 20px;
                        ...
                        <div class="card-body">
                            <form>
                                ...
                                <div class="row bordercss">
                                  ...
                                  <div class="col-md-4">
                                      <div class="form-group bmd-form-group">
                                          <label class="bmd-label-floating">Descrption</label>
                                          <textarea id="transliterateTextarea" style="width:600px;height:200px" class="form-control"></textarea>
                                      </div>
                                  </div>
