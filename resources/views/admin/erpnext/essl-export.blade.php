            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="GET" action="{{ url('/attendnce-essl-export') }}">
                                <div class="row">
                                   {{--  <div class="col-md-3">
                                    ...
                                    <div class="col-md-4">
                                        <div class="">
                                         <button type="submit" class="btn btn-primary"><i class="fa fa-file-excel-o"></i></button>
                                         <a href="{{ url('/attendanceessl/export?start_date='.$yesterday_date.'&end_date='.$today_date) }}" class="btn btn-danger"><i class="fa fa-refresh"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </form>
