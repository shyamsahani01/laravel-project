                        ...
                        @if (count($employee_data) > 0)
                          ...
                          ?>
                               <tr  style="text-align: center;">
                                 ...
                                 <td>{{ round($data->base, 2)  }}</td>
                                 <td>{{ round($data->per_day_sallery, 2)  }}</td>
                                 <td>{{ round( $per_hour_salary, 2)   }}</td>
                                 <td>{{ round( $over_time_salary, 2)  }}</td>
                               </tr>
                          @endforeach
                       @else
                         <tr>
    ...
    buttons: [
      {
        ...
        filename: function(){
                var d = new Date();
                var n = d.getTime();
                return 'fg_data_details_unit_1_' + n;
            }
      },
      {
        extend: 'csv',
