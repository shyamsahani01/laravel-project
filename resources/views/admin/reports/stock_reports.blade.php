            ...
            <a class="btn btn-primary pull-right" href="{{url('/reports')}}" style="margin-right: 22px">BACK</a>
             <div class="row card container-fluid">
                <div class="row" id="element">
                    <iframe width="100%" height="541.25" src="https://app.powerbi.com/view?r=eyJrIjoiNmZkZDExYmItYjljYS00ZjFkLTgwOWYtOGQ3NzZlM2U3MmEwIiwidCI6IjdiMTRjNmE3LTE4MTktNDE2NC1iMjEyLTFlZDNlZTQyMzIxOSJ9" style="min-height:100vh;width:100%" frameborder="0" allowFullScreen="true"></iframe>
                </div>
             </div>
        </div>
        <!-- Footer -->
