...
@section('content')
    ...
    <div class="main-panel">
        ...
        <div class="content">
            ...
            <button id="go-button-hr-report" class="btn btn-primary ">Enable Full Screen</button>
            <a class="btn btn-primary pull-right" href="{{url('/reports')}}" style="margin-right: 22px">BacK</a>
             <div class="row card container-fluid" id="element">
                <div class="row">
                    <iframe width="100%" id="go-button-hr-report-iframe" height="541.25" src="https://app.powerbi.com/view?r=eyJrIjoiN2IzZjUwMTQtNGIzZi00ZDVhLTkwM2QtNDc1NmY2NzlhYzI2IiwidCI6IjdiMTRjNmE3LTE4MTktNDE2NC1iMjEyLTFlZDNlZTQyMzIxOSJ9&pageName=ReportSection" style="min-height:100vh;width:100%"  frameborder="0" allowFullScreen="true"></iframe>
                </div>
             </div>
        </div>
        <!-- Footer -->
...
$("#go-button-hr-report").on('click', function() {
    if(IsFullScreenCurrently())
        GoOutFullscreen();
    else
        GoInFullscreen($("#go-button-hr-report-iframe").get(0));
});
