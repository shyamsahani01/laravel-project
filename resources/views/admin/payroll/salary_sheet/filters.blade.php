<div class="container-fluid card">
   @if(request()->segment(2) == 'salary_sheet')
   <div class="x_title">
      <h2>{{ $title }}</h2>
      <div class="clearfix"></div>
   </div>
   <form method="GET" id="filter_form" action="{{ url('/hr/salary_sheet') }}">
         ...
         <div class="row">
           ...
           <div class="col-md-2 col-sm-12  form-group">
            ...
            <div class="col-md-2 col-sm-6">
               ...
               <a href="{{ url('/hr/salary_sheet') }}" style="color: white;" ><button type="button" title="Refresh" class="btn btn-danger"><i class="fa fa-refresh"></i></button></a>


               <a href="{{ url('/hr/salary_sheet/export?company='.request()->company.'&employee_name='.request()->employee_name.'&month='.request()->month.'&year='.request()->year . '&show='.request()->show) }}"  style="color: white;"><button type="button" title="Excel" class="btn btn-info"><i class="fa fa-file-excel-o"></i></button></a>
