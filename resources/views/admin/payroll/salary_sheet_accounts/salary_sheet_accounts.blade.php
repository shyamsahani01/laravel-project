...
@section('content')
@php
$showurl = url('/hr/salary_sheet_accounts?show='.request()->show.'&company='.request()->company.'&employee_name='.request()->employee_name.'&status='.request()->status.'&year='.request()->year);
@endphp

    <div class="main-panel">
        <div class="content">
            @includeif('admin.payroll.salary_sheet_accounts.filters')
                                       ...
                                       <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                                          ...
                                          <tbody>
                                            ...
                                            <tr  style="text-align: center;">
                                              ...
                                              <td>{{ number_format($indirect_1) }}</td>
